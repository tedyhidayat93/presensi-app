                                ...
                                @foreach ($data as $row) 
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('adm.location.edit', $row->id)}}" class="btn btn-info btn-icon wd-35 ht-35 ">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <i class="fa fa-question-circle tx-100 tx-info lh-1 mg-t-20 d-inline-block"></i>
                <h4 class="tx-info tx-semibold mg-b-20">Yakin ingin {{$row->is_active == 0 ? 'mengaktifkan':'non aktifkan' }} Zona ini ?
                </h4>
                ...
                <form action="{{route('adm.location.status')}}" method="POST">
                    ...
                    <button type="submit" class="btn btn-info tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium mg-b-20">Ya, {{$row->is_active == 0 ? 'Aktifkan':'Non Aktifkan' }}</button>
                </form>
            </div><!-- modal-body -->
        </div><!-- modal-content -->
    </div><!-- modal-dialog -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <h4 class="tx-danger tx-semibold mg-b-20">Yakin ingin menghapus Zona ?
                </h4>
