                                ...
                                @foreach ($data as $row) 
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @canany(['admin-jenis-lembur-edit'])
                                            <a href="{{route('adm.master.edit.jenis_lembur', $row->id)}}" class="btn btn-info btn-icon wd-35 ht-35 ">
...
@push('active-jenisLembur')
active
@endpush

@push('menuOpen-jenisLembur')
style="display: block;"
@endpush

@push('showSub-jenisLembur')
show-sub
@endpush
