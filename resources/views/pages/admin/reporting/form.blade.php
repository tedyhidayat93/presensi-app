            ...
            <div class="col-12 col-md">
                <div class="form-group mb-0 mr-1">
                    ...
                    <select name="jenis_presensi" class="form-control" >
                        ...
                        <option {{ request()->query('jenis_presensi') == 'absen_lembur' ? 'selected' : ''}} value="absen_lembur">Presensi Lembur</option>
                        <option {{ request()->query('jenis_presensi') == 'absen_biasa_lembur' ? 'selected' : ''}} value="absen_biasa_lembur">Presensi Harian & Lembur</option>
                    </select>
                </div>
            </div>
            <div class="col-12 col-md">
