            ...
            <div class="card pd-0 bd-0 shadow-base">
                <div class="pd-x-30 pd-t-30 pd-b-10">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="text-13 text-uppercase text-inverse font-weight-bold text-spacing-1 mb-0">Lokasi Absen Masuk
                            </h6>
        ...
        <div class="col-12 col-md-6">
            <div class="card pd-0 bd-0 shadow-base">
                <div class="pd-x-30 pd-t-30 pd-b-10">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="text-13 text-uppercase text-inverse font-weight-bold text-spacing-1 mb-0">Lokasi Absen Pulang
                            </h6>
                            <small>Tanggal : <b> {{ date('d-M-Y', strtotime($data->date))}} </b></small>
                        </div>
                        <div class="text-13">
