            ...
            <div class="card pd-0 bd-0 shadow-base">
                <div class="pd-x-30 pd-t-30 pd-b-10">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mb-0">Lokasi Presensi Masuk
                            </h6>
                ...
                <div class="pd-x-15 pd-b-15">
                    ...
                    @if ($site->is_using_radius != 0)
                        ...
                        <div class="d-flex align-items-center justify-content-center bg-light" style="width:100%; height:345px;">
                            <h5>Karyawan Belum Melakukan Presensi Masuk</h5>
                        </div>
                        @endif
                    @else
        ...
        <div class="col-12 col-md-6">
            <div class="card pd-0 bd-0 shadow-base">
                <div class="pd-x-30 pd-t-30 pd-b-10">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1 mb-0">Lokasi Presensi Pulang
                            </h6>
                            <small>Tanggal : <b> {{ date('d-M-Y', strtotime($data->date))}} </b></small>
                        </div>
                        <div class="tx-13">
